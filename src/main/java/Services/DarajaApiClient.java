...
import com.example.pethealthcareapp.Interceptor.AccessTokenInterceptor;
...
public class DarajaApiClient {
    ...
    private HttpLoggingInterceptor=new HttpLoggingInterceptor;
...
private Retrofit getRestAdapter(){
        ...
        if (mAuthToken !=null as !mAuthToken.isEmpty()) {
    ...
    public STKPushService mpesaService() { return getRestAdapter().create(STKPushService.class); }
}
